...
C     WRITE(KO,20)
      RETURN
100   WRITE(KO,105) EMAX
105   FORMAT(/' Everywhere zero???       ',1p,e12.4/)
      RETURN
      END
...
20    CONTINUE
      RETURN
      END
      COMPLEX*16 FUNCTION FFCI(PP,F,N)
      INTEGER, INTENT(IN):: N
