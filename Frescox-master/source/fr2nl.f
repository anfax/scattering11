...
!     X           wd,wdr,wda,wdr0,awd,defp,deft,vd,vdr,vda
	...
	open(ko1,recl=130,form='formatted',delim='apostrophe')
	open(ko2,recl=200,form='formatted',delim='apostrophe')
!	open(ko3,recl=130,form='formatted',delim='apostrophe')
	open(kos,recl=130,form='formatted',delim='apostrophe',   
     X			status='scratch')
	open(11,recl=130,form='formatted',delim='apostrophe')
	eps = 1d-5
	keep = .false.
	rlmasses = .false.
      	read(ki,1005) headng
...
2031    format('     plane=',i3)
     ...
     x				rmatr,bndx,weak,meigs
2035	format('     nrbases=',i2,' nrbmin=',i2,' buttle=',i2,
     x      ' pralpha=',l1,' pcon=',i1,'  rmatr=',f8.2,'  bndx=',2f8.4,
